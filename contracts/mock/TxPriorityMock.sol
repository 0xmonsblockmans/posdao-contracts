...
contract TxPriorityMock is TxPriority {
    ...
    constructor(
        address _owner,
        bool _applyInitTestRules
    ) public TxPriority(_owner) {
        if (_applyInitTestRules) {
            ...
            destinationByWeight[4] = Destination(
                0x1100000000000000000000000000000000000001,
                0x00000000,
                4
            );
            weightByDestination[0x1100000000000000000000000000000000000001][
                0x00000000
            ] = 4;
            weightsCount++;
            ...
            destinationByWeight[3] = Destination(
                0x2000000000000000000000000000000000000001,
                0x00000000,
                3
            );
            weightByDestination[0x2000000000000000000000000000000000000001][
                0x00000000
            ] = 3;
            weightsCount++;
            ...
            destinationByWeight[2] = Destination(
                0x1000000000000000000000000000000000000001,
                0x00000000,
                2
            );
            weightByDestination[0x1000000000000000000000000000000000000001][
                0x00000000
            ] = 2;
            weightsCount++;

            // sendersWhitelist = ["0x32E4E4c7c5d1CEa5db5F9202a9E4D99E56c91a24"]
            _sendersWhitelist.push(
                address(0x32E4E4c7c5d1CEa5db5F9202a9E4D99E56c91a24)
            );

            // target = StakingAuRa.address, fnSignature = 0x48aaa4a2, minGasPrice = 100 gwei
            _minGasPriceIndex[0x1100000000000000000000000000000000000001][
                0x48aaa4a2
            ...
            _minGasPriceIndex[0x15B5c5A3D4bF2F2Dfc356A442f72Df372743d7cB][
                0x00000000
            ] = _minGasPrices.length;
            _minGasPrices.push(
                Destination(
                    0x15B5c5A3D4bF2F2Dfc356A442f72Df372743d7cB,
                    0x00000000,
                    1000000000
                )
            );
    ...
    function nextWeightInTree(
        uint256 _afterWeight
    ) external view returns (uint256) {
        return _weightsTree.next(_afterWeight);
    }

    function prevWeightInTree(
        uint256 _beforeWeight
    ) external view returns (uint256) {
