...
//                 _ids[i] = IValidatorSetAuRa(_contracts[0]).idByStakingAddress(
//                     _stakingAddresses[i]
//                 );
//             }
...
//         IRandomAuRa(_contracts[2]).initialize(
//             _collectRoundLength,
//             _contracts[0],
//             true
//         );
...
contract InitializerAuRa {
    constructor(
        ...
        // Initialize ValidatorSetAuRa contract
        IValidatorSetAuRa(_contracts[0]).initialize(
            _contracts[1], // BlockRewardAuRa
            _contracts[6], // Governance
            _contracts[2], // RandomAuRa
            _contracts[3], // StakingAuRa
            _miningAddresses,
            _stakingAddresses,
            _firstValidatorIsUnremovable
        );
